...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        if (id.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Informe o ID do produto!", "Atencao", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }
        ProdutosDAO produtosdao = new ProdutosDAO();
        produtosdao.venderProduto(Integer.parseInt(id.trim()));
        listarProdutos();
